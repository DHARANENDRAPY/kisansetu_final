...
import { FaUser, FaPhone, FaCreditCard, FaUniversity, FaRegEnvelope, FaImage } from "react-icons/fa";

export default function FarmerDetailsModal({ onClose }) {
  ...
  // Set email when component loads
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Basic validation
    if (!formData.name || !formData.lastName || !formData.mobileNumber) {
    ...
    try {
      const response = await fetch("https://localhost:7087/api/Farmer/addFarmerdata", {
        method: "POST",
        headers: { 
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          onClose();
          navigate("/farmer"); // Add navigation to farmers page---------------------------------------------------------------------------
        }, 1500);
      } else {
      ...
      <div className="relative w-full max-w-lg bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-h-[90vh] overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-800 p-4 sm:p-5 sticky top-0 z-10">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-white">Farmer Profile Setup</h2>
              <p className="text-green-100 text-sm">Please complete your profile to continue</p>
            </div>
            <button 
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="mb-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="relative">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Alternate Mobile (Optional)</label>
                  <input
                    type="tel"
            ...
            <div className="mb-5">
              <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-3">Payment Information</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="relative">
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">IFSC Code <span className="text-red-500">*</span></label>
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-gray-500 dark:text-gray-400">
                        <FaUniversity />
                      </div>
